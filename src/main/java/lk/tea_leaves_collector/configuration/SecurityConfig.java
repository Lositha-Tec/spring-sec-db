...
import lk.tea_leaves_collector.asset.user_management.service.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  private final String[] ALL_PERMIT_URL = {"/img/**", "/css/**", "/js/**", "/webjars/**",
      "/login", "/select/**", "/", "/index"};
        ...
        .authorizeRequests(
            authorizeRequests ->
                authorizeRequests
                    ...
                    .antMatchers("/category/**").hasAnyRole("ADMIN", "PROCUREMENT_MANAGER", "MANAGER")
